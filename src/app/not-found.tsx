  ...
  return (
    <main className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <div className="mx-auto max-w-md animate-fade-in">
        ...
        <h1 className="mt-4 font-display text-2xl font-bold">{config.pages.notFound.heading}</h1>
        <p className="mt-2 text-muted">{config.pages.notFound.body}</p>
        <Link
          href="/"
